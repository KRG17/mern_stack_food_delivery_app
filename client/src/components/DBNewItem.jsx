...
const DBNewItem = () => {
  ...
  //Firebase storage, to upload to firebase and get download url, refer the below url for the steps to upload image on firebase
    ...
    <div className="flex items-center justify-center flex-col pt-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
        ...
        <motion.button
          ...
          {...buttonClick}
          className="w-9/12 py-2 rounded-md bg-orange-400 text-primary hover:bg-orange-500"
        >
          Save
        </motion.button>
      </div>
