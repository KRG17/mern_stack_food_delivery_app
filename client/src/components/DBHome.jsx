...
const DBHome = () => {
  ...
  //parsing the whole products,applying filtering then picking item one by one and then picking item.product_category for that particular item and storing it.
  ...
  return (
    <div className="flex items-center justify-center flex-col pt-6 w-full h-full">
      <div className="grid w-full grid-cols-1 md:grid-cols-2 gap-4 h-full pt-20">
        <div className="flex items-center justify-center bg-slate-50 border-orange-200 border-4">
        ...
        <div className="w-full h-full flex items-center justify-center bg-slate-50 border-4 border-orange-200">
